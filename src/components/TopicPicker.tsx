          ...
          return (
            ...
            >
              <div className="flex items-start justify-between gap-3 mb-3">
                <span
                  className={`text-[10px] uppercase tracking-widest px-2 py-1 border ${accent}`}
                >
                  {topic}
                </span>
              ...
              <div className="flex items-center justify-between">
                <span
                  className="serif text-2xl text-stone-900"
                  style={{ fontWeight: 500 }}
                >
                  Drill it
                </span>
                <ChevronRight
                  className="w-4 h-4 text-stone-500 transition-transform group-hover:translate-x-1"
                  strokeWidth={2}
                />
              </div>
            </button>
